...
namespace Backend.Model
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<SanPham_DienThoai> sanPham_DienThoais { get; set; }
        public DbSet<SanPham_Audio> sanPham_Audios { get; set; }
        public DbSet<SanPham_Appliance> sanPham_Appliances { get; set; }
